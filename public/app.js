...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TRANSLATIONS = {
    vi: {
      ...
      changelog_date_v184: "1 Tháng 6, 2026",
      changelog_title_v184: "📱 Tối Ưu Hóa Giao Diện Mood Board Trên Di Động (Mobile Canvas Fix)",
      changelog_li1_v184: "<span class=\"highlight-cyan\">Sửa Lỗi Khung Nhìn Mood Board:</span> Khắc phục lỗi sập chiều cao khung nhìn canvas trên thiết bị di động bằng cách cố định chiều cao hợp lý.",
      changelog_li2_v184: "<span class=\"highlight-cyan\">Thanh Công Cụ Co Giãn:</span> Tự động xuống dòng các nhóm phím chức năng trên mobile, giúp các nút bấm không bị tràn viền và dễ thao tác.",
      changelog_date_v183: "27 Tháng 5, 2026",
      changelog_title_v183: "🛡️ Cơ Chế Dự Phòng Huấn Luyện Lại Gemini Thích Ứng (Robust Gemini Retraining)",
      changelog_li1_v183: "<span class=\"highlight-purple\">Dự Phòng Endpoint API:</span> Bổ sung danh sách các URL endpoint dự phòng (v1/v1beta, gemini-1.5-flash/gemini-2.5-flash) khi kích hoạt tự động huấn luyện lại mô hình.",
      changelog_li2_v183: "<span class=\"highlight-purple\">Xử Lý Lỗi Bền Bỉ:</span> Tự động thử lại các endpoint thay thế nếu endpoint chính gặp sự cố, đảm bảo tiến trình huấn luyện lại mô hình ML luôn hoạt động thông suốt.",
    ...
    en: {
      ...
      changelog_date_v184: "June 1, 2026",
      changelog_title_v184: "📱 Mobile Mood Board Canvas & Toolbar Optimization (v1.8.4)",
      changelog_li1_v184: "<span class=\"highlight-cyan\">Canvas Viewport Fix:</span> Resolved collapsed mood board canvas viewport height on mobile screens by forcing a clean default layout height.",
      changelog_li2_v184: "<span class=\"highlight-cyan\">Adaptive Toolbar Layout:</span> Allowed toolbar button groups and controls to wrap naturally on narrow screens, improving mobile accessibility and touch interaction.",
      changelog_date_v183: "May 27, 2026",
      changelog_title_v183: "🛡️ Robust Gemini Retraining Fallbacks (v1.8.3)",
      changelog_li1_v183: "<span class=\"highlight-purple\">API Endpoint Fallbacks:</span> Integrated a list of backup URLs (v1/v1beta protocols, gemini-1.5-flash/gemini-2.5-flash models) during the automated model retraining trigger.",
      changelog_li2_v183: "<span class=\"highlight-purple\">Resilient Error Handling:</span> Dynamically attempts alternative endpoints upon failure of the primary API key or route, ensuring continuous model updates without system disruption.",
